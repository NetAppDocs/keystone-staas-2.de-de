...
+
** *Ausgenutzte Kapazität*: Gesamtspeicherplatz in Verwendung, einschließlich Daten- und Snapshot-Kapazität.
...
** *Burst-Kapazität*: Die maximal zulässige Burst-Kapazität für Ihr Abonnement.
...
Sie können die voraussichtliche Kapazitätsauslastung für die nächsten 120 Tage ab dem aktuellen Datum über die *Prognose*-Umschaltfläche in der Ansicht *Historischer Verbrauch* auf der Registerkarte *Verbrauchstrend* in der Console einsehen. Die Umschaltfläche ist standardmäßig aktiviert.
