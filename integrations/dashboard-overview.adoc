...
* Während die Console und Digital Advisor einige exklusive Funktionen bieten, stellt die Console administrative Funktionalität für Keystone bereit, sodass Sie Abonnements verwalten und notwendige Anpassungen vornehmen können. Weitere Informationen finden Sie unter link:https://docs.netapp.com/us-en/console-setup-admin/reference-iam-keystone-roles.html["Keystone -Zugriffsrollen in der NetApp Console"^].
...
| Ja | Nein 
 ...
 a| 
link:../integrations/options.html#generate-reports-from-netapp-console-or-digital-advisor["Berichte erstellen"]
| Ja | Ja 
