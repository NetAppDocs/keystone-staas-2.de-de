...
+
image:console-subscription-timeline-graph.png["Ein Screenshot, der die Abonnementzeitleiste in einem Liniendiagrammformat zusammen mit wichtigen Ereignissen anzeigt"]
