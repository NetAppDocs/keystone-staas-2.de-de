...
+
image:console-current-consumption-graph.png["Details zum Stromverbrauch im grafischen Format"]
...
+
image:console-current-consumption-table.png["Angaben zum Stromverbrauch in Tabellenform"]
