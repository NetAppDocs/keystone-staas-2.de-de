...
+
Sie sehen detaillierte Informationen zu Volumes in Clustern, einschließlich Volume-Name, Knotenseriennummer, Einhaltung von QoS-Richtlinien, Clustername, Hostname und Performance-Servicelevel. Sie können außerdem die bereitgestellte Kapazität, die logische und physische Auslastung, Cold Data und Hot Data überwachen.
